...
function (_React$Component) {
  ...
  function CartItem() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "cancel", function (product_id) {
      var id = _this.props.id; //let findById = Array(id).filter((search)=> search.id === id);

      console.log(id); //database.collection("cart").doc(JSON.stringify(findById)).delete()
    });
...
//# sourceMappingURL=index.js.4398e95847efa86acec4.hot-update.js.map