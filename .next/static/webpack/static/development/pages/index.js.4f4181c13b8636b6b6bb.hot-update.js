      ...
      database.collection("cart").onSnapshot(function (snapshot) {
        snapshot.docChanges().forEach(function (ChangeData) {
          if (ChangeData.type === "removed") {
            database.collection("cart").doc(book_name).delete().then(function () {
              document.getElementById("cart").remove(book_name);
...
//# sourceMappingURL=index.js.4f4181c13b8636b6b6bb.hot-update.js.map