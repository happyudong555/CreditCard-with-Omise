  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ShoppingCart, [{
    ...
    value: function componentDidMount() {
      ...
      database.collection("cart").onSnapshot(function (snapshot) {
        var findItem = snapshot.docs.map(function (product) {
          return product.data;
        });

        _this2.setState({
          item: snapshot.docs.map(function (product) {
            return product.data;
          })
        });
      });
...
//# sourceMappingURL=index.js.9565ef2eb89a08c982ca.hot-update.js.map