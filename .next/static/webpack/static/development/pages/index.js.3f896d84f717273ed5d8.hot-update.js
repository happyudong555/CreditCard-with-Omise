...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ShoppingCart, [{
      ...
      database.collection("cart").onSnapshot(function (snapshot) {
        snapshot.docChanges().forEach(function (ChangeData) {
          ...
          if (ChangeData.type === "removed") {
            ...
            var removeItem = _this2.state.total.filter(function (id) {
              return id !== _price;
            });

            _this2.state.total.push(removeItem); //console.log(this.state.total)
    ...
    value: function render() {
      var price = this.state.total; //console.log(this.state.item)
...
//# sourceMappingURL=index.js.3f896d84f717273ed5d8.hot-update.js.map